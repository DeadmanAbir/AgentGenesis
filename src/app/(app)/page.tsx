  ...
  return (
    <>
      <PageHeader className=" relative z-30  ">
        <Beam />
        <div className="absolute inset-0 -z-10 h-full w-full  dark:bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] bg-[radial-gradient(#000000_1px,transparent_1px)] [background-size:30px_30px]  [mask-image:radial-gradient(ellipse_80%_50%_at_10%_50%,#000_20%,transparent_130%)]"></div>
