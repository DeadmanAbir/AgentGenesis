...
const JoinTheWaitListForm = () => {
  ...
  return (
    <form className="text-white flex md:flex-row flex-col items-center justify-center  md:w-[600px] gap-5 px-10   ">
      ...
      <button className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-gray-50 w-1/2">
