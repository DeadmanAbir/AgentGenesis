---
title: SerpApi Tool
description: Using the SerpApi tool, you may link your chains and agents to Google. An abstraction layer for the Serp API. When searching Google for answers to issues on current events, this tool comes in helpful.
---
